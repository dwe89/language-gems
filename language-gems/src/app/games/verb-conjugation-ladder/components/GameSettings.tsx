...
const themes = [
  ...
  { 
    ...
    description: 'Climb through the stars with an astronaut',
    icon: '🚀'
  },
  { 
    id: 'ocean', 
    label: 'Ocean Deep', 
    description: 'Dive through ocean depths with a scuba diver',
    icon: '🌊'
  },
  { 
    id: 'mountain', 
...
export default function GameSettings({ 
  ...
  return (
    <div className="bg-white shadow-lg rounded-lg p-6 w-full max-w-3xl mx-auto">
      <h2 className="text-2xl font-bold text-center mb-6">Conjugation Ladder Settings</h2>
