/**
 * Comprehensive Page Title Configuration for Language Gems
 * 
 * This file contains optimized SEO titles for all pages on the Language Gems platform.
 * These titles are designed to:
 * 1. Include target keywords
 * 2. Be under 60 characters when possible
...
export const PAGE_TITLES = {
  ...
  '/explore': 'Explore LanguageGems Features | Interactive Language Learning',
  ...
  // BLOG PAGES
  // ===============================
  '/blog': 'Language Learning Blog - GCSE Tips, Teaching Strategies & Educational Insights',
  '/blog/complete-guide-spaced-repetition-vocabulary-learning': 'The Complete Guide to Spaced Repetition for Vocabulary Learning (2024)',
  '/blog/complete-guide-gcse-spanish-vocabulary-themes': 'Complete Guide to GCSE Spanish Vocabulary Themes (AQA, Edexcel, OCR) 2024',
  '/blog/best-vocabulary-learning-techniques-gcse': 'The 7 Best Vocabulary Learning Techniques for GCSE Success (2024)',
  '/blog/language-learning-apps-vs-educational-software': 'Language Learning Apps vs. Educational Software: What Schools Need to Know (2024)',
  '/blog/gamification-language-learning-classroom': 'How Gamification Transforms Language Learning in the Classroom',
  
  // ===============================
  // LANGUAGE-SPECIFIC LANDING PAGES
  // ===============================
  '/gcse-spanish-learning': 'GCSE Spanish Learning Games & Vocabulary Platform | Language Gems',
  '/gcse-french-learning': 'GCSE French Learning Games & Vocabulary Platform | Language Gems',
  '/gcse-german-learning': 'GCSE German Learning Games & Vocabulary Platform | Language Gems',
  '/gcse-language-learning': 'GCSE Language Learning Games & Vocabulary Platform | Language Gems',
  ...
  '/exam-style-assessment/task': 'GCSE Assessment Task | Practice Test | Language Gems',
  ...
  '/reading-comprehension/task': 'Reading Comprehension Task | GCSE Practice | Language Gems',
  
  '/four-skills-assessment': 'Four Skills Assessment | Complete GCSE Language Test | Language Gems',
  '/four-skills-assessment/test': 'Four Skills Test | GCSE Language Assessment | Language Gems',
  ...
  '/exams/aqa/ks4_gcse/listening': 'AQA GCSE Listening Practice | Audio Tests | Language Gems',
  '/exams/aqa/ks4_gcse/speaking': 'AQA GCSE Speaking Practice | Oral Tests | Language Gems',
  '/exams/aqa/ks4_gcse/writing': 'AQA GCSE Writing Practice | Written Tests | Language Gems',
  ...
  '/resources/skills/spanish/vocabulary': 'Spanish Vocabulary Resources | GCSE Word Lists | Language Gems',
  '/resources/skills/french/vocabulary': 'French Vocabulary Resources | GCSE Word Lists | Language Gems',
  '/resources/skills/german/vocabulary': 'German Vocabulary Resources | GCSE Word Lists | Language Gems',
  '/resources/skills/spanish/grammar': 'Spanish Grammar Resources | GCSE Practice | Language Gems',
  '/resources/skills/french/grammar': 'French Grammar Resources | GCSE Practice | Language Gems',
  '/resources/skills/german/grammar': 'German Grammar Resources | GCSE Practice | Language Gems',
  ...
  '/dashboard/analytics/gem-collector': 'Gem Collector Analytics | Teacher Dashboard | Language Gems',
  '/dashboard/vocabulary': 'Vocabulary Management | Teacher Dashboard | Language Gems',
  '/dashboard/vocabulary/create': 'Create Vocabulary List | Teacher Dashboard | Language Gems',
  ...
  '/dashboard/games': 'Games Overview | Teacher Dashboard | Language Gems',
  '/dashboard/home': 'Dashboard Home | Teacher Overview | Language Gems',
  '/dashboard/preview': 'Preview Mode | Teacher Dashboard | Language Gems',
  '/dashboard/progress': 'Progress Overview | Teacher Dashboard | Language Gems',
  '/dashboard/achievements': 'Student Achievements | Teacher Dashboard | Language Gems',
  '/dashboard/vocabulary-mining': 'Vocabulary Mining Dashboard | Teacher Tools | Language Gems',
  '/dashboard/vocabulary-mining/curriculum': 'Curriculum Mapping | Vocabulary Mining | Language Gems',
  '/dashboard/vocabulary-mining/controls': 'Mining Controls | Teacher Dashboard | Language Gems',
  '/dashboard/vocabulary-mining/reports': 'Mining Reports | Teacher Analytics | Language Gems',
  '/dashboard/content': 'Content Management | Teacher Dashboard | Language Gems',
  ...
  '/student-dashboard/exam-prep': 'Exam Preparation | Student Dashboard | Language Gems',
  '/student-dashboard/assessments': 'My Assessments | Student Dashboard | Language Gems',
  '/student-dashboard/vocabulary-mining': 'Vocabulary Mining | Student Dashboard | Language Gems',
  '/student-dashboard/vocabulary/analysis': 'Vocabulary Analysis | Student Dashboard | Language Gems',
  '/student-dashboard/vocabulary/practice': 'Vocabulary Practice | Student Dashboard | Language Gems',
  '/student-dashboard/vocabulary/progress': 'Vocabulary Progress | Student Dashboard | Language Gems',
  '/student-dashboard/vocabulary/review': 'Vocabulary Review | Student Dashboard | Language Gems',
  '/student-dashboard/vocabmaster': 'VocabMaster | Student Dashboard | Language Gems',
  '/student-dashboard/preview': 'Preview Mode | Student Dashboard | Language Gems',
  ...
  '/account/upgrade': 'Upgrade Account | My Account | Language Gems',
  ...
  '/admin/blog/new': 'Create Blog Post | Admin Dashboard | Language Gems',
  '/admin/products': 'Product Management | Admin Dashboard | Language Gems',
  '/admin/worksheets': 'Worksheet Management | Admin Dashboard | Language Gems',
  '/admin/freebies': 'Freebies Management | Admin Dashboard | Language Gems',
  '/admin/audio-generation': 'Audio Generation | Admin Dashboard | Language Gems',
  '/admin/new': 'Create New | Admin Dashboard | Language Gems'
};
...
// Function to check if a route should be noindexed
export function shouldNoIndex(route: string): boolean {
  return NO_INDEX_ROUTES.some(prefix => route.startsWith(prefix));
}

// Function to get optimized title for a route
export function getOptimizedTitle(route: string): string | null {
  return PAGE_TITLES[route as keyof typeof PAGE_TITLES] || null;
}

// Function to get all routes that need titles
export function getAllRoutesNeedingTitles() {
