...
const WORD_LIST_RESOURCES = [
  ...
  },
  {
    id: 'thematic-lists',
    name: 'Thematic Lists',
    description: 'Vocabulary organized by topics like food, travel, family',
    languages: ['Spanish', 'French', 'German'],
    difficulty: 'Beginner',
    resources: 25,
    words: 800
  },
  {
    ...
    description: 'Advanced words for academic and professional contexts',
    languages: ['Spanish', 'French', 'German'],
    difficulty: 'Advanced',
    resources: 15,
    words: 600
  },
  {
    ...
    description: 'Key words for GCSE, A-Level, and university exams',
    languages: ['Spanish', 'French', 'German'],
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-white rounded-xl shadow-sm p-8 mb-8">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-slate-900">Word Lists</h1>
              <p className="text-slate-600 mt-2">Curated vocabulary lists for systematic learning</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-6 text-sm text-slate-600">
            <div className="flex items-center gap-2">
              ...
              <span>{WORD_LIST_RESOURCES.length} Categories</span>
            </div>
            <div className="flex items-center gap-2">
              <BookOpen className="h-4 w-4" />
              <span>{WORD_LIST_RESOURCES.reduce((acc, cat) => acc + cat.words, 0)} Words</span>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {WORD_LIST_RESOURCES.map((resource) => (
