...
const BOOKLET_RESOURCES = [
  {
    id: 'beginner-booklets',
    name: 'Beginner Booklets',
    description: 'Comprehensive vocabulary booklets for new learners',
  ...
  {
    id: 'intermediate-booklets',
    name: 'Intermediate Booklets',
    description: 'Advanced vocabulary with exercises and examples',
    languages: ['Spanish', 'French', 'German'],
  ...
  {
    id: 'exam-prep-booklets',
    name: 'Exam Prep Booklets',
    description: 'Targeted vocabulary for GCSE and A-Level exams',
    languages: ['Spanish', 'French', 'German'],
    difficulty: 'Intermediate',
    resources: 8,
    pages: 40
  ...
  {
    id: 'revision-booklets',
    name: 'Revision Booklets',
    description: 'Quick reference guides for vocabulary review',
    languages: ['Spanish', 'French', 'German'],
  ...
  {
    id: 'interactive-booklets',
    name: 'Interactive Booklets',
    description: 'Digital booklets with clickable elements and audio',
    languages: ['Spanish', 'French', 'German'],
    difficulty: 'All Levels',
    resources: 6,
    pages: 28
...
export default function VocabBookletsPage() {
  return (
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-white rounded-xl shadow-sm p-8 mb-8">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-slate-900">Vocab Booklets</h1>
              <p className="text-slate-600 mt-2">Comprehensive vocabulary booklets for structured learning</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-6 text-sm text-slate-600">
            <div className="flex items-center gap-2">
              ...
              <span>{BOOKLET_RESOURCES.length} Booklet Types</span>
            </div>
            <div className="flex items-center gap-2">
              <BookOpen className="h-4 w-4" />
              <span>{BOOKLET_RESOURCES.reduce((acc, cat) => acc + cat.resources, 0)} Booklets</span>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {BOOKLET_RESOURCES.map((resource) => (
