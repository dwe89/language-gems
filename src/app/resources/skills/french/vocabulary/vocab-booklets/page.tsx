...
const FRENCH_BOOKLET_RESOURCES = [
  {
    id: 'beginner-french-booklets',
    name: 'Beginner French Booklets',
    description: 'Comprehensive French vocabulary booklets for new learners',
    difficulty: 'Beginner',
    resources: 12,
    pages: 24
  },
  {
    id: 'intermediate-french-booklets',
    name: 'Intermediate French Booklets',
    description: 'Advanced French vocabulary with exercises and examples',
    difficulty: 'Intermediate',
    resources: 10,
    pages: 32
  },
  {
    id: 'french-exam-prep-booklets',
    name: 'French Exam Prep Booklets',
    description: 'Targeted French vocabulary for GCSE and A-Level exams',
    difficulty: 'Intermediate',
    resources: 8,
    pages: 40
  },
  {
    id: 'french-revision-booklets',
    name: 'French Revision Booklets',
    description: 'Quick reference guides for French vocabulary review',
    difficulty: 'All Levels',
    resources: 15,
    pages: 16
  },
  {
    id: 'interactive-french-booklets',
    name: 'Interactive French Booklets',
    description: 'Digital French booklets with clickable elements and audio',
    difficulty: 'All Levels',
    resources: 6,
    pages: 28
  }
...
export default function FrenchVocabBookletsPage() {
  return (
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-white rounded-xl shadow-sm p-8 mb-8">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-slate-900">French Vocab Booklets</h1>
              <p className="text-slate-600 mt-2">Comprehensive French vocabulary booklets for structured learning</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-6 text-sm text-slate-600">
            <div className="flex items-center gap-2">
              ...
              <span>{FRENCH_BOOKLET_RESOURCES.length} Booklet Types</span>
            </div>
            <div className="flex items-center gap-2">
              <BookOpen className="h-4 w-4" />
              <span>{FRENCH_BOOKLET_RESOURCES.reduce((acc, cat) => acc + cat.resources, 0)} French Booklets</span>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {FRENCH_BOOKLET_RESOURCES.map((resource) => (
