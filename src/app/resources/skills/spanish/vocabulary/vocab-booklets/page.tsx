...
const SPANISH_BOOKLET_RESOURCES = [
  {
    id: 'beginner-spanish-booklets',
    name: 'Beginner Spanish Booklets',
    description: 'Comprehensive Spanish vocabulary booklets for new learners',
    difficulty: 'Beginner',
    resources: 12,
    pages: 24
  },
  {
    id: 'intermediate-spanish-booklets',
    name: 'Intermediate Spanish Booklets',
    description: 'Advanced Spanish vocabulary with exercises and examples',
    difficulty: 'Intermediate',
    resources: 10,
    pages: 32
  },
  {
    id: 'spanish-exam-prep-booklets',
    name: 'Spanish Exam Prep Booklets',
    description: 'Targeted Spanish vocabulary for GCSE and A-Level exams',
    difficulty: 'Intermediate',
    resources: 8,
    pages: 40
  },
  {
    id: 'spanish-revision-booklets',
    name: 'Spanish Revision Booklets',
    description: 'Quick reference guides for Spanish vocabulary review',
    difficulty: 'All Levels',
    resources: 15,
    pages: 16
  },
  {
    id: 'interactive-spanish-booklets',
    name: 'Interactive Spanish Booklets',
    description: 'Digital Spanish booklets with clickable elements and audio',
    difficulty: 'All Levels',
    resources: 6,
    pages: 28
  }
...
export default function SpanishVocabBookletsPage() {
  return (
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-white rounded-xl shadow-sm p-8 mb-8">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-slate-900">Spanish Vocab Booklets</h1>
              <p className="text-slate-600 mt-2">Comprehensive Spanish vocabulary booklets for structured learning</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-6 text-sm text-slate-600">
            <div className="flex items-center gap-2">
              ...
              <span>{SPANISH_BOOKLET_RESOURCES.length} Booklet Types</span>
            </div>
            <div className="flex items-center gap-2">
              <BookOpen className="h-4 w-4" />
              <span>{SPANISH_BOOKLET_RESOURCES.reduce((acc, cat) => acc + cat.resources, 0)} Spanish Booklets</span>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {SPANISH_BOOKLET_RESOURCES.map((resource) => (
