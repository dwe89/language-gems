...
const SPANISH_SKILLS = [
  {
    ...
    icon: BookOpen,
    description: 'Master Spanish verb conjugations, tenses, and sentence structures',
    color: 'indigo',
    topics: ['Present Tense', 'Past Tenses', 'Future & Conditional', 'Subjunctive', 'Ser vs Estar']
  },
  {
    id: 'vocabulary',
    name: 'Spanish Vocabulary',
    icon: Users,
    description: 'Build your Spanish vocabulary with targeted word lists and frequency packs',
    color: 'green',
    topics: ['Essential Words', 'Thematic Lists', 'Frequency Packs', 'Exam Vocabulary']
  },
  {
    id: 'exam-practice',
    name: 'Spanish Exam Practice',
    icon: FileText,
    description: 'Prepare for GCSE, A-Level, and university Spanish exams',
    color: 'yellow',
    topics: ['Reading Comprehension', 'Listening Practice', 'Speaking Tasks', 'Writing Skills']
  }
];

export default function SpanishSkillsPage() {
  return (
        ...
        <div className="bg-white rounded-xl shadow-sm p-8 mb-8">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-3xl font-bold text-slate-900">Spanish Skills</h1>
                <p className="text-slate-600 mt-2">Master Spanish with comprehensive learning resources</p>
              </div>
            </div>
          </div>
        </div>
            ...
            return (
              <div key={skill.id} className={`bg-white rounded-xl shadow-sm hover:shadow-md transition-all duration-200 overflow-hidden border-t-4 border-${skill.color}-500`}>
                <div className="p-8">
                  ...
                  <Link
                    href={`/resources/skills/spanish/${skill.id}`}
