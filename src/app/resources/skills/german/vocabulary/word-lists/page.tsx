...
const GERMAN_WORD_LIST_RESOURCES = [
  {
    id: 'essential-german-words',
    name: 'Essential German Words',
    description: 'Core German vocabulary for everyday communication',
    difficulty: 'Beginner',
    resources: 20,
    words: 500
  },
  {
    id: 'thematic-german-lists',
    name: 'Thematic German Lists',
    description: 'German vocabulary organized by topics like Essen, Reisen, Familie',
    difficulty: 'Beginner',
    resources: 25,
    words: 800
  },
  {
    id: 'academic-german-vocabulary',
    name: 'Academic German Vocabulary',
    description: 'Advanced German words for academic and professional contexts',
    difficulty: 'Advanced',
    resources: 15,
    words: 600
  },
  {
    id: 'german-exam-vocabulary',
    name: 'German Exam Vocabulary',
    description: 'Key German words for GCSE, A-Level, and university exams',
...
export default function GermanWordListsPage() {
  return (
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-white rounded-xl shadow-sm p-8 mb-8">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-slate-900">German Word Lists</h1>
              <p className="text-slate-600 mt-2">Curated German vocabulary lists for systematic learning</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-6 text-sm text-slate-600">
            <div className="flex items-center gap-2">
              ...
              <span>{GERMAN_WORD_LIST_RESOURCES.length} Categories</span>
            </div>
            <div className="flex items-center gap-2">
              <BookOpen className="h-4 w-4" />
              <span>{GERMAN_WORD_LIST_RESOURCES.reduce((acc, cat) => acc + cat.words, 0)} German Words</span>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {GERMAN_WORD_LIST_RESOURCES.map((resource) => (
