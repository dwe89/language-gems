...
const GERMAN_VOCABULARY_GAMES = [
  {
    id: 'german-word-match',
    name: 'German Word Match',
  ...
  {
    id: 'german-crossword',
    name: 'German Crossword Puzzles',
    description: 'Interactive crossword puzzles with German vocabulary',
    difficulty: 'Intermediate',
    duration: '15-20 min',
    players: 'Single Player'
  },
  {
    id: 'german-memory-cards',
    name: 'German Memory Cards',
    description: 'Flip cards to match German words with images',
    difficulty: 'Beginner',
    duration: '10-15 min',
    players: 'Single Player'
  },
  {
    id: 'german-word-builder',
    name: 'German Word Builder',
    description: 'Build German words from scrambled letters',
    difficulty: 'Intermediate',
    duration: '8-12 min',
    players: 'Single Player'
  },
  {
    id: 'german-quiz-challenge',
    name: 'German Quiz Challenge',
    description: 'Timed German vocabulary quizzes with scoring',
    difficulty: 'All Levels',
    duration: '5-15 min',
    players: 'Single/Multi Player'
  },
  {
    id: 'german-story-builder',
    name: 'German Story Builder',
    description: 'Create stories using German vocabulary words',
    difficulty: 'Advanced',
    duration: '20-30 min',
    players: 'Single Player'
  }
...
export default function GermanVocabularyGamesPage() {
  return (
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-white rounded-xl shadow-sm p-8 mb-8">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-slate-900">German Vocabulary Games</h1>
              <p className="text-slate-600 mt-2">Interactive German vocabulary games and activities</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-6 text-sm text-slate-600">
            <div className="flex items-center gap-2">
              ...
              <span>{GERMAN_VOCABULARY_GAMES.length} Games Available</span>
            </div>
          </div>
        </div>  
      {/* Games Grid */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {GERMAN_VOCABULARY_GAMES.map((game) => (
