...
const GERMAN_SKILLS = [
  {
    ...
    name: 'German Grammar',
    icon: BookOpen,
    description: 'Master German verb conjugations, cases, and sentence structures',
    color: 'indigo',
    topics: ['Present Tense', 'Past Tenses', 'Cases (Nom/Acc/Dat/Gen)', 'Modal Verbs', 'Word Order']
  },
  {
    id: 'vocabulary',
    name: 'German Vocabulary',
    icon: Users,
    description: 'Build your German vocabulary with targeted word lists and frequency packs',
    color: 'green',
    topics: ['Essential Words', 'Thematic Lists', 'Frequency Packs', 'Exam Vocabulary']
  },
  {
    id: 'exam-practice',
    name: 'German Exam Practice',
    icon: FileText,
    description: 'Prepare for GCSE, A-Level, and university German exams',
    color: 'yellow',
    ...
    <div className="min-h-screen bg-slate-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex items-center gap-2 mb-6">
          ...
          <span className="text-slate-400">/</span>
          <span className="text-slate-600">German</span>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-sm p-8 mb-8">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div className="flex items-center gap-4">
              ...
              />
              <div>
                <h1 className="text-3xl font-bold text-slate-900">German Skills</h1>
                <p className="text-slate-600 mt-2">Build strong German foundations with comprehensive resources</p>
              </div>
            </div>
          </div>
        </div>
            ...
            return (
              <div key={skill.id} className={`bg-white rounded-xl shadow-sm hover:shadow-md transition-all duration-200 overflow-hidden border-t-4 border-${skill.color}-500`}>
                <div className="p-8">
                  ...
                  <Link
                    href={`/resources/skills/german/${skill.id}`}
