...
const GERMAN_EXAM_TOPICS = [
  {
    id: 'reading-comprehension',
    name: 'Reading Comprehension',
    description: 'German reading passages with questions and analysis',
  ...
  },
  {
    ...
    description: 'Audio exercises with native German speakers',
    difficulty: 'All Levels',
    resources: 14,
    examBoards: ['AQA', 'Edexcel', 'OCR'],
  ...
  },
  {
    id: 'writing-skills',
    name: 'Writing Skills',
    description: 'Essays, letters, and creative writing in German',
    difficulty: 'Intermediate',
    resources: 16,
    examBoards: ['AQA', 'Edexcel', 'OCR'],
  ...
  },
  {
    ...
    description: 'Targeted practice for GCSE German exams',
    difficulty: 'Intermediate',
    resources: 21,
    examBoards: ['AQA', 'Edexcel', 'OCR'],
  ...
  },
  {
    ...
    description: 'Advanced German exam preparation and practice',
    difficulty: 'Advanced',
    resources: 19,
    examBoards: ['AQA', 'Edexcel', 'OCR'],
...
export default function GermanExamPracticePage() {
  return (
    <div className="min-h-screen bg-slate-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex items-center gap-2 mb-6">
          ...
          <span className="text-slate-400">/</span>
          <Link href="/resources/skills/german" className="text-yellow-600 hover:text-yellow-700">German</Link>
          <span className="text-slate-400">/</span>
        ...
        <div className="bg-white rounded-xl shadow-sm p-8 mb-8">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-3xl font-bold text-slate-900">German Exam Practice</h1>
                <p className="text-slate-600 mt-2">Prepare for your German exams with targeted practice</p>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center gap-6 text-sm text-slate-600">
            <div className="flex items-center gap-2">
              ...
              <span>{GERMAN_EXAM_TOPICS.length} Practice Areas</span>
            </div>
            <div className="flex items-center gap-2">
              <FileText className="h-4 w-4" />
              <span>{GERMAN_EXAM_TOPICS.reduce((acc, topic) => acc + topic.resources, 0)} Practice Resources</span>
            </div>
          </div>
        </div>
