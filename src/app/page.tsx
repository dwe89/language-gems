          ...
          <div className="w-full relative min-h-[90vh] flex items-center justify-center overflow-hidden bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100">
            ...
            <div className="container mx-auto px-6 z-10 py-20">
              <div className="text-center max-w-5xl mx-auto">
                ...
                >
                  The complete GCSE language learning platform for Spanish, French, and German. 
                  Perfect for schools, teachers, and individual learners worldwide.
                </motion.p>
          ...
          <div className="py-20 bg-gradient-to-r from-blue-600 to-purple-600 text-white">
            <div className="container mx-auto px-6 text-center">
              ...
              <p className="text-xl text-blue-100 mb-8 max-w-3xl mx-auto">
                Join thousands of learners and educators who are already experiencing the LanguageGems difference.
              </p>
