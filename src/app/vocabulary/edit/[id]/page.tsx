    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900">Edit Vocabulary Collection</h1>
          <p className="text-gray-600 mt-2">Update your vocabulary collection: {vocabularyList.name}</p>
        </div>
