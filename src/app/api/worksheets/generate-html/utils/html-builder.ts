...
export function createHTMLDocument(
    ...
    <div class="header">
      <div class="header-inner">
        <div class="header-left">
          <img src="${logoSrc}" alt="LanguageGems" class="worksheet-logo" />
        </div>
        <div class="header-center">
          <div class="subtitle">LanguageGems Worksheets</div>
        </div>
        <div class="header-right">
          <!-- Meta info can be filled by generators if needed -->
        </div>
      </div>
    </div>
  `;
  ...
  const footerHtml = `
    <div class="footer">
      Generated by <strong>LanguageGems</strong> | The Intelligent Language Learning Platform | <a href="https://languagegems.com">LanguageGems.com</a>
    </div>
  `;
