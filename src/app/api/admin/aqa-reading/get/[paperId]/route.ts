...
/**
 * GET /api/admin/aqa-reading/get/[paperId]
 * Get a specific AQA reading paper with all its questions
 * Admin only endpoint
 */
export async function GET(
  ...
  try {
    ...
    const totalMarks = paper.aqa_reading_questions?.reduce(
    ...
    const paperWithStats = {
      ...
      questions: paper.aqa_reading_questions || []
    };
    ...
    console.error('Error in GET /api/admin/aqa-reading/get/[paperId]:', error);
    return NextResponse.json(
