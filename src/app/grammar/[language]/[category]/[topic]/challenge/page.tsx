...
import { ArrowLeft, Play, Trophy, Clock, Heart, Award, CheckCircle, AlertCircle } from 'lucide-react';
...
export default function ChallengePage({ params }: ChallengePageProps) {
    ...
    const loadTopicData = async () => {
      try {
        ...
        if (topic) {
          ...
          setCategoryName(formatTopicName(topic.category));
          
          // Check if practice content exists
          ...
          setTopicData({ hasContent: !!practiceContent });
        } else {
          setTopicName(formatTopicName(params.topic));
          setCategoryName(formatTopicName(params.category));
  ...
  const handleTestModeClick = () => {
    ...
    if (!isAuthenticated || !user) {
      ...
      window.location.href = `/grammar/${params.language}/${params.category}/${params.topic}/test`;
    }
  };
        ...
        <div className="max-w-4xl mx-auto">
          <div className="mb-6">
            ...
            >
              ...
              Back to {formatTopicName(params.language)} Grammar
            </Link>
          </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-8">
          ...
          <GemCard className="relative overflow-hidden group hover:shadow-xl transition-all duration-300">
            ...
            <div className="relative z-10 p-6">
              ...
              <Link
                href={`/grammar/${params.language}/${params.category}/${params.topic}/practice`}
