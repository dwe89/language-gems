        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-gray-300 mb-4">
              A multi-language learning platform for schools and individual learners.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-300">
              <li><Link href="/resources/blog" className="hover:text-white">Blog</Link></li>
          ...
          <div>
            <h3 className="text-lg font-semibold mb-4 text-white">For Schools</h3>
            <p className="text-gray-300 mb-4">
              Special plans for schools and educational institutions.
            </p>
            <Link href="/schools" className="pink-gem-button">
              Learn More
            </Link>
          </div>
        </div>
