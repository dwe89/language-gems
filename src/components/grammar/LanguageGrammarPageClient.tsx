...
// Removed useParams import as we will pass language as prop
...
interface LanguageGrammarPageClientProps {
    language: string;
}

export default function LanguageGrammarPageClient({ language }: LanguageGrammarPageClientProps) {
    const { user } = useAuth();
                ...
                <div className="mb-12">
                    ...
                    <div className="flex flex-wrap justify-center gap-3">
                        <button
                            ...
                            className={`px-6 py-3 rounded-full text-sm font-medium transition-all duration-200 ${selectedCategory === 'all'
                        ...
                        {getCategories().map((category) => (
                            <button
                                ...
                                className={`px-6 py-3 rounded-full text-sm font-medium transition-all duration-200 capitalize ${selectedCategory === category
                                        ? 'bg-gradient-to-r from-purple-500 to-blue-500 text-white shadow-lg'
                                        : 'bg-white text-gray-700 hover:bg-gray-50 border border-gray-200 shadow-sm'
                                    }`}
                            >
                        ...
                        return (
                            ...
                            >
                                <div className="space-y-4">
                                    <div className="flex items-center justify-between">
                                        <span className={`px-3 py-1 rounded-full text-xs font-medium bg-gradient-to-r ${DIFFICULTY_COLORS[topic.difficulty_level as keyof typeof DIFFICULTY_COLORS]
                                            } text-white`}>
