    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        ...
        <div className="space-y-3">
          {(analytics.topicPerformance || analytics.tensePerformance || []).slice(0, 8).map((item: any) => (
            <div key={item.topicId || item.tense} className="flex items-center justify-between">
          ...
          <div key={student.studentId} className="border border-gray-200 rounded-lg p-4">
            <div className="flex items-center justify-between mb-3">
              <div>
                ...
                <p className="text-sm text-gray-600">
                  {student.totalAttempts} attempts • {student.topicsMastered || student.tensesMastered || 0} / {analytics.classStats.totalTopicsTracked || analytics.classStats.totalTensesTracked || 0} Topics Known
                </p>
              </div>
              <div className="text-right">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-2">
              {(student.topicBreakdown || student.tenseBreakdown || []).slice(0, 4).map((item: any) => (
